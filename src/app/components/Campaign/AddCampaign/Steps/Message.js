...
import DynamicVariableMenu from '../DynamicVariableMenu';
import SendTemplateDialog from '../../../SendTemplateDialog/SendTemplateDialog';
            ...
            <Alert 
              ...
              action={
                <Button
                  color="inherit"
                  size="small"
                  onClick={() => router.push(`/templates?search=${encodeURIComponent(template.TemplateName)}`)}
                  sx={{ 
                    minWidth:'200px',
                    fontWeight: 600,
                    textTransform: 'none',
