...
import { fetchQuickReport } from '../../API/CampaignList/QuickReport';
import { fetchTemplateMessages } from '../../API/CampaignList/TemplateMessages';
...
import { formatDate, getMessageStatus, normalizeMobileNumber } from '../../utils/globalFunc';
...
const CampaignReport = () => {
    ...
    const metrics = [
        { label: 'All', value: quickReportData?.OverallPercentage ? `${quickReportData?.OverallPercentage}%` : '0%', count: quickReportData?.Overall || 0, icon: LayoutDashboard, color: '#7367f0', bg: 'rgba(115, 103, 240, 0.12)' },
